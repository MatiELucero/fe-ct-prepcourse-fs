...
function promedioResultadosTest(resultadosTest) {
   ...
   // return promedio;
   return agregarNumeros(resultadosTest) / resultadosTest.length // reutlizando funcion
}
...
function cuentoElementos(array) {
   ...
   // return acum;
   var count = 0;
   array.forEach((elemento) => {if(elemento > 18) count++;
   }) 
   return count;
}
console.log(cuentoElementos([1,24,2,6]));
